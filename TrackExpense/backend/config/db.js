...
export const connectDB = async () => {
  ...
  // Guard against placeholder values in .env
  if (uri.includes("<") || uri.includes("xxxx")) {
    throw new Error(
      "MONGO_URI looks like a placeholder. Update backend/.env with your actual Atlas connection string (replace <username>, <password>, and <your-cluster-host>).");
  }
